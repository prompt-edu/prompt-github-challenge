            ...
            ((passingPosition !== undefined && passingPosition <= 150) ||
              ...
              <Alert variant='default'>
                ...
                <AlertDescription>
                  ...
                  participate in the GitHub Challenge course!
                </AlertDescription>
              </Alert>
            )}
          {passed &&
            ...
            fetchedParticipation?.passStatus !== 'passed' && (
              <Alert variant='default'>
                ...
                <AlertDescription>
                  ...
                  capacity, you have been placed on the waitlist for the GitHub Challenge course.
                </AlertDescription>
              </Alert>
            )}
          {!passed && remainingAttempts === 0 && (
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription className='pt-2'>
                ...
                <strong>{remainingAttempts}</strong> attempt
