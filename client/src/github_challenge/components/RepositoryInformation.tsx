          ...
          <div className="flex flex-col space-y-1">
            <div className="space-y-4">
              <p className="text-slate-700 leading-relaxed">
                We have created a repository for you. Only you have access to
                this repository.
              </p>
              ...
              <Alert variant="default">
                ...
                <AlertDescription className="text-amber-700">
                  You must solve this challenge independently! No collaboration
              ...
              <div className="space-y-1">
                <p className="text-slate-700 leading-relaxed">
                  You may use GenAI tools such as Github Co-Pilot or ChatGPT,
                  but make sure that you understand what you are doing!
                </p>

                <ol className="list-decimal pl-5 text-slate-700 space-y-2 my-4">
                  <li>Open the GitHub repository using the link below</li>
                  <li>
                    Carefully read the Challenge Description in the README
                  </li>
                ...
                <p className="text-slate-700 leading-relaxed">
                  When you think you have successfully solved the challenge,
                  click on Start Testing.
                  <br />
                  You have at most 3 attempts to test your solution, so use them
                  wisely.
                </p>
              </div>
            </div>
