...
export const GithubUsernameInput = () => {
  ...
  const isInputValid =
    githubUsername.length > 0 && !validationError && hasGithubProfile;
      ...
      <CardContent className="space-y-6">
        <Alert className="bg-black-50 border-black-200">
          ...
          <AlertDescription className="text-black-700">
            For this challenge, you need a Github account. Enter your GitHub
            username to create a repository for this challenge. If you do not
            have one, please signup on:{" "}
            <a
            ...
            your Github account so that we can verify your identity.
          </AlertDescription>
        </Alert>
          ...
          <div className="flex items-start space-x-2 mt-4">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setHasGithubProfile(checked as boolean)
              }
            />
            <label
            ...
            >
              I confirm that my GitHub account has my full name and a profile
              picture set up.
            </label>
          </div>
        ...
        {repositoryMutation.isSuccess && (
          <Alert className="bg-green-50 border-green-200">
            ...
            <AlertDescription className="text-green-700">
              Your repository has been created successfully. You can now start
              the challenge.
            </AlertDescription>
          </Alert>
        )}
